...
and the [opentelemetry-collector-contrib v0.133.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.133.0) releases where appropriate.
