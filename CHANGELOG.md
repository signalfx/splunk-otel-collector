...
- (Splunk) Update Python to 3.12.5 in the Smart Agent bundle for Linux and Windows. Check [https://docs.python.org/3/whatsnew/3.12.html](https://docs.python.org/3/whatsnew/3.12.html) for details. ([#5298](https://github.com/signalfx/splunk-otel-collector/pull/5298))
