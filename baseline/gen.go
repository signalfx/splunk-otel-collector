...
// Regenerate components_gen.go from builder-config.yaml. The OpenTelemetry
...
//go:generate go run ./internal/gen ./internal/gen/ocb/components.go components_gen.go
