...
- `splunk_ingest_url`: The Splunk ingest URL, e.g.
  `https://ingest.us0.splunkcloud.com`. The `SPLUNK_INGEST_URL` environment
  variable will be set with this value for the collector service. (**default:**
  `https://ingest.{{ splunk_realm }}.splunkcloud.com`)

- `splunk_api_url`: The Splunk API URL, e.g. `https://api.us0.splunkcloud.com`.
  The `SPLUNK_API_URL` environment variable will be set with this value for the
  collector service. (**default:** `https://api.{{ splunk_realm }}.splunkcloud.com`)

- `splunk_hec_url`: The Splunk HEC endpoint URL, e.g.
  `https://ingest.us0.splunkcloud.com/v1/log`. The `SPLUNK_HEC_URL` environment
  variable will be set with this value for the collector service. (**default:**
