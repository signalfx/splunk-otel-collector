> The official Splunk documentation for this page is [Install the Collector for Kubernetes](https://docs.splunk.com/Observability/gdi/opentelemetry/install-k8s.html). For instructions on how to contribute to the docs, see [CONTRIBUTING.md](../CONTRIBUTING#documentation.md).
# Kubernetes YAML
