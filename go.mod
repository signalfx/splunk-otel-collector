...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/ciscoosreceiver v0.143.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/icmpcheckreceiver v0.143.0
