...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/httpforwarderextension v0.111.0
...
// TODO: Remove once https://github.com/hashicorp/go-secure-stdlib/pull/136 is merged
replace (
	...
	github.com/testcontainers/testcontainers-go => github.com/testcontainers/testcontainers-go v0.31.0
)
