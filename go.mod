...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/metricstransformprocessor v0.55.1-0.20220711202355-100d245647bf
...
require (
	...
	github.com/signalfx/signalfx-go v1.21.0 // indirect
