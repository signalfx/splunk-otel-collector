...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/httpforwarderextension v0.128.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/opampextension v0.128.0
