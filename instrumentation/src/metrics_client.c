...
bool connect_http(const char *host, int port, int socket_descriptor);

bool post(int socket_descriptor, char *host, int port, char *method, char *path, char *postData);
