...
| **databricks.spark.codegenerator.compilationtime.mean** | n/a |  | Gauge(Double) | <ul> <li>cluster_id</li> <li>spark_app_id</li> <li>pipeline_id</li> <li>pipeline_name</li> </ul> |
| **databricks.spark.codegenerator.generatedclasssize.mean** | n/a |  | Gauge(Double) | <ul> <li>cluster_id</li> <li>spark_app_id</li> <li>pipeline_id</li> <li>pipeline_name</li> </ul> |
| **databricks.spark.codegenerator.generatedmethodsize.mean** | n/a |  | Gauge(Double) | <ul> <li>cluster_id</li> <li>spark_app_id</li> <li>pipeline_id</li> <li>pipeline_name</li> </ul> |
| **databricks.spark.codegenerator.sourcecodesize.mean** | n/a |  | Gauge(Double) | <ul> <li>cluster_id</li> <li>spark_app_id</li> <li>pipeline_id</li> <li>pipeline_name</li> </ul> |
