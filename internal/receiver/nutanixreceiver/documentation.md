...
Latest Nutanix Prism statistic for a cluster. The runtime metric name appends the normalized statistic name.
...
Latest Nutanix Prism statistic for a physical disk. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix Files antivirus server. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix Files file server. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix Files mount target. The runtime metric name appends the normalized statistic name.
...
Latest Nutanix Prism statistic for a host. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix Layer 2 stretch. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix traffic mirror. The runtime metric name appends the normalized statistic name.
...
Latest statistic for an external subnet attached to a Nutanix VPC. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix VPN connection. The runtime metric name appends the normalized statistic name.
...
Latest statistic for a Nutanix Objects object store. The runtime metric name appends the normalized statistic name.
...
Latest Nutanix Prism statistic for a storage container. The runtime metric name appends the normalized statistic name.
...
Latest Nutanix Prism statistic for a virtual machine. The runtime metric name appends the normalized statistic name.
...
Latest Nutanix Prism statistic for a volume group. The runtime metric name appends the normalized statistic name.
