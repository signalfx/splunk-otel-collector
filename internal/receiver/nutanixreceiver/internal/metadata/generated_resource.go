...
// SetNutanixPrismAPIVersion sets provided value as "nutanix.prism.api.version" attribute.
func (rb *ResourceBuilder) SetNutanixPrismAPIVersion(val string) {
	if rb.config.NutanixPrismAPIVersion.Enabled {
		rb.res.Attributes().PutStr("nutanix.prism.api.version", val)
	}
}
