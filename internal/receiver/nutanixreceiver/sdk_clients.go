...
func configureGeneratedSDKClient(client generatedSDKClient, fields generatedSDKFields, baseURL *url.URL, cfg *Config) {
	...
	*fields.connectTimeout = cfg.ControllerConfig.Timeout
	// The released Nutanix SDKs negotiate versions by issuing an OPTIONS
	// request and assume a byte response body even for error responses. Prism
	// Element and older Prism Central endpoints commonly return 404 here. Use
	// the version compiled into each released client instead.
	if fields.allowVersionNegotiation != nil {
		*fields.allowVersionNegotiation = false
	}
...
func newPrismV4Client(cfg *Config) (*prismClient, error) {
	...
	configureGeneratedSDKClient(clusterSDK, generatedSDKFields{&clusterSDK.Scheme, &clusterSDK.Host, &clusterSDK.Port, &clusterSDK.ReadTimeout, &clusterSDK.ConnectTimeout, &clusterSDK.AllowVersionNegotiation}, baseURL, cfg)
	vmmSDK := vmmClient.NewApiClient()
	configureGeneratedSDKClient(vmmSDK, generatedSDKFields{&vmmSDK.Scheme, &vmmSDK.Host, &vmmSDK.Port, &vmmSDK.ReadTimeout, &vmmSDK.ConnectTimeout, &vmmSDK.AllowVersionNegotiation}, baseURL, cfg)
	volumesSDK := volumesClient.NewApiClient()
	configureGeneratedSDKClient(volumesSDK, generatedSDKFields{&volumesSDK.Scheme, &volumesSDK.Host, &volumesSDK.Port, &volumesSDK.ReadTimeout, &volumesSDK.ConnectTimeout, &volumesSDK.AllowVersionNegotiation}, baseURL, cfg)
	networkingSDK := networkingClient.NewApiClient()
	configureGeneratedSDKClient(networkingSDK, generatedSDKFields{&networkingSDK.Scheme, &networkingSDK.Host, &networkingSDK.Port, &networkingSDK.ReadTimeout, &networkingSDK.ConnectTimeout, &networkingSDK.AllowVersionNegotiation}, baseURL, cfg)
	prismSDK := prismSDKClient.NewApiClient()
	configureGeneratedSDKClient(prismSDK, generatedSDKFields{&prismSDK.Scheme, &prismSDK.Host, &prismSDK.Port, &prismSDK.ReadTimeout, &prismSDK.ConnectTimeout, &prismSDK.AllowVersionNegotiation}, baseURL, cfg)
	monitoringSDK := monitoringClient.NewApiClient()
	configureGeneratedSDKClient(monitoringSDK, generatedSDKFields{&monitoringSDK.Scheme, &monitoringSDK.Host, &monitoringSDK.Port, &monitoringSDK.ReadTimeout, &monitoringSDK.ConnectTimeout, &monitoringSDK.AllowVersionNegotiation}, baseURL, cfg)
	dataPoliciesSDK := dataPoliciesClient.NewApiClient()
	configureGeneratedSDKClient(dataPoliciesSDK, generatedSDKFields{&dataPoliciesSDK.Scheme, &dataPoliciesSDK.Host, &dataPoliciesSDK.Port, &dataPoliciesSDK.ReadTimeout, &dataPoliciesSDK.ConnectTimeout, &dataPoliciesSDK.AllowVersionNegotiation}, baseURL, cfg)
	dataProtectionSDK := dataProtectionClient.NewApiClient()
	configureGeneratedSDKClient(dataProtectionSDK, generatedSDKFields{&dataProtectionSDK.Scheme, &dataProtectionSDK.Host, &dataProtectionSDK.Port, &dataProtectionSDK.ReadTimeout, &dataProtectionSDK.ConnectTimeout, &dataProtectionSDK.AllowVersionNegotiation}, baseURL, cfg)
	microsegSDK := microsegClient.NewApiClient()
	configureGeneratedSDKClient(microsegSDK, generatedSDKFields{&microsegSDK.Scheme, &microsegSDK.Host, &microsegSDK.Port, &microsegSDK.ReadTimeout, &microsegSDK.ConnectTimeout, &microsegSDK.AllowVersionNegotiation}, baseURL, cfg)
	filesSDK := filesClient.NewApiClient()
	configureGeneratedSDKClient(filesSDK, generatedSDKFields{&filesSDK.Scheme, &filesSDK.Host, &filesSDK.Port, &filesSDK.ReadTimeout, &filesSDK.ConnectTimeout, nil}, baseURL, cfg)
	objectsSDK := objectsClient.NewApiClient()
	configureGeneratedSDKClient(objectsSDK, generatedSDKFields{&objectsSDK.Scheme, &objectsSDK.Host, &objectsSDK.Port, &objectsSDK.ReadTimeout, &objectsSDK.ConnectTimeout, &objectsSDK.AllowVersionNegotiation}, baseURL, cfg)
