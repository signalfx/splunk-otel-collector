...
type WriterConfig struct {
	...
	DatapointMaxBatchSize int `yaml:"datapointMaxBatchSize"`
	...
	// with the oldest.
	MaxDatapointsBuffered int `yaml:"maxDatapointsBuffered"`
	// The analogue of `datapointMaxBatchSize` for trace spans.
	TraceSpanMaxBatchSize int `yaml:"traceSpanMaxBatchSize"`
	// Format to export traces in. Choices are "zipkin" and "sapm"
	TraceExportFormat string `yaml:"traceExportFormat"`
	...
	EventSendIntervalSeconds int `yaml:"eventSendIntervalSeconds"`
	// The analogue of `maxRequests` for dimension property requests.
	PropertiesMaxRequests uint `yaml:"propertiesMaxRequests"`
	...
	PropertiesMaxBuffered uint `yaml:"propertiesMaxBuffered"`
	...
	// property generation.
	PropertiesSendDelaySeconds uint `yaml:"propertiesSendDelaySeconds"`
	...
	PropertiesHistorySize uint `yaml:"propertiesHistorySize"`
	...
	SendTraceHostCorrelationMetrics *bool `yaml:"sendTraceHostCorrelationMetrics"`
	...
	StaleServiceTimeout timeutil.Duration `yaml:"staleServiceTimeout"`
	...
	TraceHostCorrelationPurgeInterval timeutil.Duration `yaml:"traceHostCorrelationPurgeInterval"`
	...
	// https://golang.org/pkg/time/#ParseDuration.  This option is irrelevant if
	// `sendTraceHostCorrelationMetrics` is false.
	TraceHostCorrelationMetricsInterval timeutil.Duration `yaml:"traceHostCorrelationMetricsInterval"`
	// How many times to retry requests related to trace host correlation
	TraceHostCorrelationMaxRequestRetries uint `yaml:"traceHostCorrelationMaxRequestRetries"`
	...
	// hardware/networking.
	MaxTraceSpansInFlight uint `yaml:"maxTraceSpansInFlight"`
	...
	SignalFxEnabled *bool `yaml:"signalFxEnabled"`
