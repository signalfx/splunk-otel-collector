...
func (am *Monitor) Configure(conf *Config) error {
	return am.SetConfigurationAndRun(conf, collectd.WithDeprecationWarningLog("[NOTICE] The collectd/postgresql plugin is deprecated and will be removed in a future release. Please migrate to the postgresql monitor."))
}
