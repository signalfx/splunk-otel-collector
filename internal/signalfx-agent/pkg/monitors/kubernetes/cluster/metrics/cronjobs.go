...
func dimensionForCronJob(cj *batchv1beta1.CronJob, sendUnsanitizedProperties bool) *atypes.Dimension {
	props, tags := k8sutil.PropsAndTagsFromLabels(cj.Labels, sendUnsanitizedProperties)
