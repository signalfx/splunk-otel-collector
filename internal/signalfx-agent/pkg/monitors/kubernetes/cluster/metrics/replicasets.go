...
func dimensionForReplicaSet(rs *appsv1.ReplicaSet, sendUnsanitizedProperties bool) *atypes.Dimension {
	props, tags := k8sutil.PropsAndTagsFromLabels(rs.Labels, sendUnsanitizedProperties)
