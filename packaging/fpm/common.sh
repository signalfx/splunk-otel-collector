...
GATEWAY_PLATFORM_CONFIG_REPO_PATH="$REPO_DIR/cmd/otelcol/config/collector/gateway_config_platform.yaml"
GATEWAY_PLATFORM_CONFIG_INSTALL_PATH="/etc/otel/collector/gateway_config_platform.yaml"
...
setup_files_and_permissions() {
    ...
    cp -f "$GATEWAY_PLATFORM_CONFIG_REPO_PATH" "$buildroot/$GATEWAY_PLATFORM_CONFIG_INSTALL_PATH"
