...
LOGS_CONFIG_REPO_PATH="$REPO_DIR/cmd/otelcol/config/collector/hec_logs_config_linux.yaml"
LOGS_CONFIG_INSTALL_PATH="/etc/otel/collector/hec_logs_config_linux.yaml"
