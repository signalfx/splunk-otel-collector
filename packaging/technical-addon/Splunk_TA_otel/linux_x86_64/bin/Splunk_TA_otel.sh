...
discovery_value=""
discovery_properties_file_name="discovery_properties_file"
discovery_properties_file_value=""
...
splunk_TA_otel_read_configs() {
    ...
    do
        ...
        has_discovery_properties_file="$(echo "$line" | grep "$discovery_properties_file_name")"
        if [ "$has_discovery_properties_file" ] ; then
            splunk_TA_otel_log_msg "DEBUG" "reading $discovery_properties_file_name from line $has_discovery_properties_file"
            discovery_properties_file_value="$(echo "$has_discovery_properties_file" | grep -Eo ">(.*?)<" | sed 's/^>\(.*\)<$/\1/')"
            splunk_TA_otel_log_msg "DEBUG" "Set $discovery_properties_file_name to $discovery_properties_file_value"
        fi
...
splunk_TA_otel_run_agent() {
    ...
    if [ "$discovery_properties_file_value" ] ; then
      SPLUNK_OTEL_FLAGS="$SPLUNK_OTEL_FLAGS --discovery-properties-file=$discovery_properties_file_value"
    else
      splunk_TA_otel_log_msg "DEBUG" "STRING PARAM NOT SET: $discovery_properties_file_name"
    fi
    # End autogenerated code
