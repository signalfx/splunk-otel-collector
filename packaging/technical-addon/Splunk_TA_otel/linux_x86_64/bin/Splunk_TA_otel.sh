...
splunk_discovery_properties_name="splunk_discovery_properties"
splunk_discovery_properties_value=""
...
splunk_TA_otel_read_configs() {
    ...
    do
        ...
        # Begin autogenerated code
        has_config_dir="$(echo "$line" | grep "$config_dir_name")"
        if [ "$has_config_dir" ] ; then
            splunk_TA_otel_log_msg "DEBUG" "reading $config_dir_name from line $has_config_dir"
            config_dir_value="$(echo "$has_config_dir" | grep -Eo ">(.*?)<" | sed 's/^>\(.*\)<$/\1/')"
            splunk_TA_otel_log_msg "DEBUG" "Set $config_dir_name to $config_dir_value"
        fi
        ...
        has_splunk_discovery_properties="$(echo "$line" | grep "$splunk_discovery_properties_name")"
        if [ "$has_splunk_discovery_properties" ] ; then
            splunk_TA_otel_log_msg "DEBUG" "reading $splunk_discovery_properties_name from line $has_splunk_discovery_properties"
            splunk_discovery_properties_value="$(echo "$has_splunk_discovery_properties" | grep -Eo ">(.*?)<" | sed 's/^>\(.*\)<$/\1/')"
            splunk_TA_otel_log_msg "DEBUG" "Set $splunk_discovery_properties_name to $splunk_discovery_properties_value"
        fi
        ...
        if [ "$has_splunk_access_token_file" ] ; then
            ...
            splunk_TA_otel_log_msg "DEBUG" "Set $splunk_access_token_file_name to $splunk_access_token_file_value"
        fi
        ...
        has_splunk_otel_log_file="$(echo "$line" | grep "$splunk_otel_log_file_name")"
        if [ "$has_splunk_otel_log_file" ] ; then
            splunk_TA_otel_log_msg "DEBUG" "reading $splunk_otel_log_file_name from line $has_splunk_otel_log_file"
            splunk_otel_log_file_value="$(echo "$has_splunk_otel_log_file" | grep -Eo ">(.*?)<" | sed 's/^>\(.*\)<$/\1/')"
        ...
        if [ "$has_splunk_trace_url" ] ; then
            ...
            splunk_TA_otel_log_msg "DEBUG" "Set $splunk_trace_url_name to $splunk_trace_url_value"
        fi
        # End autogenerated code
...
splunk_TA_otel_run_agent() {
    ...
    splunk_discovery_file_path_value="$(Splunk_TA_otel_expand_config_param "$splunk_discovery_file_path_value")"
    config_dir_value="$(Splunk_TA_otel_expand_config_param "$config_dir_value")"
    ...
    if [ "$splunk_trace_url_value" ] ; then
      ...
      splunk_TA_otel_log_msg "DEBUG" "NOT SET: $splunk_trace_url_name"
    fi
    ...
    if [ "$config_dir_value" ] ; then
      SPLUNK_OTEL_FLAGS="$SPLUNK_OTEL_FLAGS --config-dir=$config_dir_value"
    else
      splunk_TA_otel_log_msg "DEBUG" "STRING PARAM NOT SET: $config_dir_name"
    fi
    if [ "$splunk_discovery_properties_value" ] ; then
      SPLUNK_OTEL_FLAGS="$SPLUNK_OTEL_FLAGS --discovery-properties=$splunk_discovery_properties_value"
    else
      splunk_TA_otel_log_msg "DEBUG" "STRING PARAM NOT SET: $splunk_discovery_properties_name"
    fi
    # End autogenerated code
