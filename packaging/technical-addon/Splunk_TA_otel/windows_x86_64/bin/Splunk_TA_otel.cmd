...
start /B "" /I /WAIT powershell -ExecutionPolicy ByPass "& { Get-WmiObject Win32_Process | ? ProcessName -eq 'otelcol_windows_amd64.exe' | ? CommandLine -like '*%command_line%*' | % { taskkill.exe /f /pid $_.ProcessId } }"
