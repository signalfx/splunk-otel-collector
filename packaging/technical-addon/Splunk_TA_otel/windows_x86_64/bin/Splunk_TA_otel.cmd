...
if "%discovery_properties_file_value%" != "true" (
    set "SPLUNK_OTEL_FLAGS=%SPLUNK_OTEL_FLAGS% --discovery-properties-file=%discovery_properties_file_value%"
) else (
    call :splunk_TA_otel_log_msg "DEBUG" "Optional flag %discovery_properties_file_name% not set"
)
:: END AUTOGENERATED CODE
...
:: expand params in discovery_properties_file_value
for /f "delims=" %%i in ('powershell -noninteractive -noprofile -command "'%discovery_properties_file_value%' -replace '\$SPLUNK_OTEL_TA_PLATFORM_HOME', '%SPLUNK_OTEL_TA_PLATFORM_HOME%'"') do (
    set "discovery_properties_file_value=%%i"
)
for /f "delims=" %%i in ('powershell -noninteractive -noprofile -command "'%discovery_properties_file_value%' -replace '\$SPLUNK_OTEL_TA_HOME', '%SPLUNK_OTEL_TA_HOME%'"') do (
    set "discovery_properties_file_value=%%i"
)
for /f "delims=" %%i in ('powershell -noninteractive -noprofile -command "'%discovery_properties_file_value%' -replace '\$SPLUNK_HOME', '%SPLUNK_HOME%'"') do (
    set "discovery_properties_file_value=%%i"
)
:: END AUTOGENERATED CODE
