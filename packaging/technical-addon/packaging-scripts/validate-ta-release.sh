...
[[ "otelcol version $OTEL_COLLECTOR_VERSION" != "otelcol version $ACTUAL_VERSION" ]] && echo "Invalid version -- Expected $OTEL_COLLECTOR_VERSION but got $ACTUAL_VERSION" && exit 1
