...
import (
	...
	"github.com/signalfx/splunk-otel-collector/pkg/extension/oracleencodingextension/internal/unmarshaler/metrics"
)
...
func newOracleExtension(logger *zap.Logger) *oracleExtension {
	return &oracleExtension{
		metricUnmarshaler: metrics.NewResourceMetricsUnmarshaler(logger),
	}
}
