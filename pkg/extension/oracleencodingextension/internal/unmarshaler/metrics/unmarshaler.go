...
// readJSONLLines reads newline-delimited records from rdr and invokes
// addRecordFn for each record.
func (r ResourceMetricsUnmarshaler) readJSONLLines(rdr io.Reader, addRecordFn func(ociMetricRecord)) error {
