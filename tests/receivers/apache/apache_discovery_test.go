...
func TestIntegrationApacheWebserverAutoDiscovery(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Successful Discovery test": {
			...
			logMessageToAssert: `apachereceiver receiver is working!`,
		},
	}
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			discoverytest.Run(t, "apache", otelConfigPath, test.logMessageToAssert)
		})
	}
}
