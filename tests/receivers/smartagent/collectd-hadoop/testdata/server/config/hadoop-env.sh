...
export HADOOP_NAMENODE_OPTS="-Dhadoop.security.logger=${HADOOP_SECURITY_LOGGER:-INFO,RFAS} \
                             ...
                             -Dcom.sun.management.jmxremote.port=5677 \
...
export HADOOP_DATANODE_OPTS=$HDFS_DATANODE_OPTS # hadoop 2.x uses this old variable name
...
export HADOOP_SECONDARYNAMENODE_OPTS=$HDFS_SECONDARYNAMENODE_OPTS # hadoop 2.x uses this old variable name
