...
func pdataMetrics() pdata.Metrics {
	...
	ilmOneMetricOneDps.AppendEmpty().SetValue(12345)
	ilmOneMetricOneDps.At(0).LabelsMap().Insert("label_name_1", "label_value_1")
	ilmOneMetricOneDps.AppendEmpty().SetValue(23456)
	...
	ilmOneMetricTwoDps.AppendEmpty().SetValue(234.56)
	ilmOneMetricTwoDps.At(0).LabelsMap().Insert("label_name_3", "label_value_3")
	ilmOneMetricTwoDps.AppendEmpty().SetValue(345.67)
	...
	ilmThreeMetricOneDps.AppendEmpty().SetValue(34567)
	ilmThreeMetricOneDps.At(0).LabelsMap().Insert("label_name_5", "label_value_5")
	ilmThreeMetricOneDps.AppendEmpty().SetValue(45678)
	...
	ilmThreeMetricTwoDps.AppendEmpty().SetValue(56789)
	ilmThreeMetricTwoDps.At(0).LabelsMap().Insert("label_name_7", "label_value_7")
	ilmThreeMetricTwoDps.AppendEmpty().SetValue(67890)
	...
	ilmThreeMetricThreeDps.AppendEmpty().SetValue(78901)
	ilmThreeMetricThreeDps.At(0).LabelsMap().Insert("label_name_9", "label_value_9")
	ilmThreeMetricThreeDps.AppendEmpty().SetValue(89012)
	...
	ilmThreeMetricFourDps.AppendEmpty().SetValue(456.78)
	ilmThreeMetricFourDps.At(0).LabelsMap().Insert("label_name_11", "label_value_11")
	ilmThreeMetricFourDps.AppendEmpty().SetValue(567.89)
	...
	ilmThreeMetricFiveDps.AppendEmpty().SetValue(678.90)
	ilmThreeMetricFiveDps.At(0).LabelsMap().Insert("label_name_13", "label_value_13")
	ilmThreeMetricFiveDps.AppendEmpty().SetValue(789.01)
	...
	ilmThreeMetricSixDps.AppendEmpty().SetValue(890.12)
	ilmThreeMetricSixDps.At(0).LabelsMap().Insert("label_name_15", "label_value_15")
	ilmThreeMetricSixDps.AppendEmpty().SetValue(901.23)
	...
	ilmThreeMetricSevenDps.AppendEmpty().SetValue(90123)
	ilmThreeMetricSevenDps.At(0).LabelsMap().Insert("label_name_17", "label_value_17")
	ilmThreeMetricSevenDps.AppendEmpty().SetValue(123456)
	...
	ilmThreeMetricEightDps.AppendEmpty().SetValue(234567)
	ilmThreeMetricEightDps.At(0).LabelsMap().Insert("label_name_19", "label_value_19")
	ilmThreeMetricEightDps.AppendEmpty().SetValue(345678)
	...
	ilmThreeMetricNineDps.AppendEmpty().SetValue(456789)
	ilmThreeMetricNineDps.At(0).LabelsMap().Insert("label_name_21", "label_value_21")
	ilmThreeMetricNineDps.AppendEmpty().SetValue(567890)
	...
	ilmThreeMetricTenDps.AppendEmpty().SetValue(1234.56)
	ilmThreeMetricTenDps.At(0).LabelsMap().Insert("label_name_23", "label_value_23")
	ilmThreeMetricTenDps.AppendEmpty().SetValue(2345.67)
	...
	ilmThreeMetricElevenDps.AppendEmpty().SetValue(3456.78)
	ilmThreeMetricElevenDps.At(0).LabelsMap().Insert("label_name_25", "label_value_25")
	ilmThreeMetricElevenDps.AppendEmpty().SetValue(4567.89)
	...
	ilmThreeMetricTwelveDps.AppendEmpty().SetValue(5678.90)
	ilmThreeMetricTwelveDps.At(0).LabelsMap().Insert("label_name_27", "label_value_27")
	ilmThreeMetricTwelveDps.AppendEmpty().SetValue(6789.01)
