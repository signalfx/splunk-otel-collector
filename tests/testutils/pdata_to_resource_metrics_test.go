...
func pdataMetrics() pmetric.Metrics {
	...
	ilmOneMetricOne.SetEmptyGauge()
	ilmOneMetricOneDps := ilmOneMetricOne.Gauge().DataPoints()
	ilmOneMetricOneDps.AppendEmpty().SetIntValue(12345)
	ilmOneMetricOneDps.At(0).Attributes().PutString("label_name_1", "label_value_1")
	ilmOneMetricOneDps.AppendEmpty().SetIntValue(23456)
	ilmOneMetricOneDps.At(1).Attributes().PutString("label_name_2", "label_value_2")
	...
	ilmOneMetricTwo.SetEmptyGauge()
	ilmOneMetricTwoDps := ilmOneMetricTwo.Gauge().DataPoints()
	ilmOneMetricTwoDps.AppendEmpty().SetDoubleVal(234.56)
	ilmOneMetricTwoDps.At(0).Attributes().PutString("label_name_3", "label_value_3")
	ilmOneMetricTwoDps.AppendEmpty().SetDoubleVal(345.67)
	ilmOneMetricTwoDps.At(1).Attributes().PutString("label_name_4", "label_value_4")
	...
	ilmThreeMetricOneDps.AppendEmpty().SetIntValue(34567)
	ilmThreeMetricOneDps.At(0).Attributes().PutString("label_name_5", "label_value_5")
	ilmThreeMetricOneDps.AppendEmpty().SetIntValue(45678)
	ilmThreeMetricOneDps.At(1).Attributes().PutString("label_name_6", "label_value_6")
	...
	ilmThreeMetricTwoDps.AppendEmpty().SetIntValue(56789)
	ilmThreeMetricTwoDps.At(0).Attributes().PutString("label_name_7", "label_value_7")
	ilmThreeMetricTwoDps.AppendEmpty().SetIntValue(67890)
	ilmThreeMetricTwoDps.At(1).Attributes().PutString("label_name_8", "label_value_8")
	...
	ilmThreeMetricThree.SetEmptySum()
	...
	ilmThreeMetricThreeDps.AppendEmpty().SetIntValue(78901)
	ilmThreeMetricThreeDps.At(0).Attributes().PutString("label_name_9", "label_value_9")
	ilmThreeMetricThreeDps.AppendEmpty().SetIntValue(89012)
	ilmThreeMetricThreeDps.At(1).Attributes().PutString("label_name_10", "label_value_10")
	...
	ilmThreeMetricFour.SetEmptySum()
	...
	ilmThreeMetricFourDps.At(0).Attributes().PutString("label_name_11", "label_value_11")
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(567.89)
	ilmThreeMetricFourDps.At(1).Attributes().PutString("label_name_12", "label_value_12")
	...
	ilmThreeMetricFive.SetEmptySum()
	...
	ilmThreeMetricFiveDps.At(0).Attributes().PutString("label_name_13", "label_value_13")
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(789.01)
	ilmThreeMetricFiveDps.At(1).Attributes().PutString("label_name_14", "label_value_14")
	...
	ilmThreeMetricSixDps.At(0).Attributes().PutString("label_name_15", "label_value_15")
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(901.23)
	ilmThreeMetricSixDps.At(1).Attributes().PutString("label_name_16", "label_value_16")
	...
	ilmThreeMetricSeven.SetEmptySum()
	...
	ilmThreeMetricSevenDps.AppendEmpty().SetIntValue(90123)
	ilmThreeMetricSevenDps.At(0).Attributes().PutString("label_name_17", "label_value_17")
	ilmThreeMetricSevenDps.AppendEmpty().SetIntValue(123456)
	ilmThreeMetricSevenDps.At(1).Attributes().PutString("label_name_18", "label_value_18")
	...
	ilmThreeMetricEight.SetEmptySum()
	...
	ilmThreeMetricEightDps.AppendEmpty().SetIntValue(234567)
	ilmThreeMetricEightDps.At(0).Attributes().PutString("label_name_19", "label_value_19")
	ilmThreeMetricEightDps.AppendEmpty().SetIntValue(345678)
	ilmThreeMetricEightDps.At(1).Attributes().PutString("label_name_20", "label_value_20")
	...
	ilmThreeMetricNine.SetEmptySum()
	...
	ilmThreeMetricNineDps.AppendEmpty().SetIntValue(456789)
	ilmThreeMetricNineDps.At(0).Attributes().PutString("label_name_21", "label_value_21")
	ilmThreeMetricNineDps.AppendEmpty().SetIntValue(567890)
	ilmThreeMetricNineDps.At(1).Attributes().PutString("label_name_22", "label_value_22")
	...
	ilmThreeMetricTenDps.At(0).Attributes().PutString("label_name_23", "label_value_23")
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(2345.67)
	ilmThreeMetricTenDps.At(1).Attributes().PutString("label_name_24", "label_value_24")
	...
	ilmThreeMetricEleven.SetEmptySum()
	...
	ilmThreeMetricElevenDps.At(0).Attributes().PutString("label_name_25", "label_value_25")
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(4567.89)
	ilmThreeMetricElevenDps.At(1).Attributes().PutString("label_name_26", "label_value_26")
	...
	ilmThreeMetricTwelve.SetEmptySum()
	...
	ilmThreeMetricTwelveDps.At(0).Attributes().PutString("label_name_27", "label_value_27")
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(6789.01)
	ilmThreeMetricTwelveDps.At(1).Attributes().PutString("label_name_28", "label_value_28")
	return metrics
}
