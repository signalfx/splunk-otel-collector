...
func pdataMetrics() pmetric.Metrics {
	...
	ilmOneMetricOne.SetDataType(pmetric.MetricDataTypeGauge)
	ilmOneMetricOneDps := ilmOneMetricOne.Gauge().DataPoints()
	ilmOneMetricOneDps.AppendEmpty().SetIntVal(12345)
	ilmOneMetricOneDps.At(0).Attributes().Insert("label_name_1", pcommon.NewValueString("label_value_1"))
	ilmOneMetricOneDps.AppendEmpty().SetIntVal(23456)
	ilmOneMetricOneDps.At(1).Attributes().Insert("label_name_2", pcommon.NewValueString("label_value_2"))
	...
	ilmOneMetricTwo.SetDataType(pmetric.MetricDataTypeGauge)
	ilmOneMetricTwoDps := ilmOneMetricTwo.Gauge().DataPoints()
	ilmOneMetricTwoDps.AppendEmpty().SetDoubleVal(234.56)
	ilmOneMetricTwoDps.At(0).Attributes().Insert("label_name_3", pcommon.NewValueString("label_value_3"))
	...
	ilmThreeMetricOne.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricOne.Sum().SetIsMonotonic(true)
	ilmThreeMetricOne.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityCumulative)
	ilmThreeMetricOneDps := ilmThreeMetricOne.Sum().DataPoints()
	ilmThreeMetricOneDps.AppendEmpty().SetIntVal(34567)
	ilmThreeMetricOneDps.At(0).Attributes().Insert("label_name_5", pcommon.NewValueString("label_value_5"))
	ilmThreeMetricOneDps.AppendEmpty().SetIntVal(45678)
	ilmThreeMetricOneDps.At(1).Attributes().Insert("label_name_6", pcommon.NewValueString("label_value_6"))
	...
	ilmThreeMetricTwo.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricTwo.Sum().SetIsMonotonic(true)
	ilmThreeMetricTwo.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityDelta)
	ilmThreeMetricTwoDps := ilmThreeMetricTwo.Sum().DataPoints()
	ilmThreeMetricTwoDps.AppendEmpty().SetIntVal(56789)
	ilmThreeMetricTwoDps.At(0).Attributes().Insert("label_name_7", pcommon.NewValueString("label_value_7"))
	ilmThreeMetricTwoDps.AppendEmpty().SetIntVal(67890)
	ilmThreeMetricTwoDps.At(1).Attributes().Insert("label_name_8", pcommon.NewValueString("label_value_8"))
	...
	ilmThreeMetricThree.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricThree.Sum().SetIsMonotonic(true)
	ilmThreeMetricThree.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityUnspecified)
	ilmThreeMetricThreeDps := ilmThreeMetricThree.Sum().DataPoints()
	ilmThreeMetricThreeDps.AppendEmpty().SetIntVal(78901)
	ilmThreeMetricThreeDps.At(0).Attributes().Insert("label_name_9", pcommon.NewValueString("label_value_9"))
	ilmThreeMetricThreeDps.AppendEmpty().SetIntVal(89012)
	ilmThreeMetricThreeDps.At(1).Attributes().Insert("label_name_10", pcommon.NewValueString("label_value_10"))
	...
	ilmThreeMetricFour.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricFour.Sum().SetIsMonotonic(true)
	ilmThreeMetricFour.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityCumulative)
	ilmThreeMetricFourDps := ilmThreeMetricFour.Sum().DataPoints()
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(456.78)
	ilmThreeMetricFourDps.At(0).Attributes().Insert("label_name_11", pcommon.NewValueString("label_value_11"))
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(567.89)
	ilmThreeMetricFourDps.At(1).Attributes().Insert("label_name_12", pcommon.NewValueString("label_value_12"))
	...
	ilmThreeMetricFive.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricFive.Sum().SetIsMonotonic(true)
	ilmThreeMetricFive.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityDelta)
	ilmThreeMetricFiveDps := ilmThreeMetricFive.Sum().DataPoints()
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(678.90)
	ilmThreeMetricFiveDps.At(0).Attributes().Insert("label_name_13", pcommon.NewValueString("label_value_13"))
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(789.01)
	ilmThreeMetricFiveDps.At(1).Attributes().Insert("label_name_14", pcommon.NewValueString("label_value_14"))
	...
	ilmThreeMetricSix.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricSix.Sum().SetIsMonotonic(true)
	ilmThreeMetricSix.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityUnspecified)
	ilmThreeMetricSixDps := ilmThreeMetricSix.Sum().DataPoints()
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(890.12)
	ilmThreeMetricSixDps.At(0).Attributes().Insert("label_name_15", pcommon.NewValueString("label_value_15"))
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(901.23)
	ilmThreeMetricSixDps.At(1).Attributes().Insert("label_name_16", pcommon.NewValueString("label_value_16"))
	...
	ilmThreeMetricSeven.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricSeven.Sum().SetIsMonotonic(false)
	ilmThreeMetricSeven.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityCumulative)
	ilmThreeMetricSevenDps := ilmThreeMetricSeven.Sum().DataPoints()
	ilmThreeMetricSevenDps.AppendEmpty().SetIntVal(90123)
	ilmThreeMetricSevenDps.At(0).Attributes().Insert("label_name_17", pcommon.NewValueString("label_value_17"))
	ilmThreeMetricSevenDps.AppendEmpty().SetIntVal(123456)
	ilmThreeMetricSevenDps.At(1).Attributes().Insert("label_name_18", pcommon.NewValueString("label_value_18"))
	...
	ilmThreeMetricEight.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricEight.Sum().SetIsMonotonic(false)
	ilmThreeMetricEight.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityDelta)
	ilmThreeMetricEightDps := ilmThreeMetricEight.Sum().DataPoints()
	ilmThreeMetricEightDps.AppendEmpty().SetIntVal(234567)
	ilmThreeMetricEightDps.At(0).Attributes().Insert("label_name_19", pcommon.NewValueString("label_value_19"))
	ilmThreeMetricEightDps.AppendEmpty().SetIntVal(345678)
	ilmThreeMetricEightDps.At(1).Attributes().Insert("label_name_20", pcommon.NewValueString("label_value_20"))
	...
	ilmThreeMetricNine.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricNine.Sum().SetIsMonotonic(false)
	ilmThreeMetricNine.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityUnspecified)
	ilmThreeMetricNineDps := ilmThreeMetricNine.Sum().DataPoints()
	ilmThreeMetricNineDps.AppendEmpty().SetIntVal(456789)
	ilmThreeMetricNineDps.At(0).Attributes().Insert("label_name_21", pcommon.NewValueString("label_value_21"))
	ilmThreeMetricNineDps.AppendEmpty().SetIntVal(567890)
	ilmThreeMetricNineDps.At(1).Attributes().Insert("label_name_22", pcommon.NewValueString("label_value_22"))
	...
	ilmThreeMetricTen.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricTen.Sum().SetIsMonotonic(false)
	ilmThreeMetricTen.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityCumulative)
	ilmThreeMetricTenDps := ilmThreeMetricTen.Sum().DataPoints()
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(1234.56)
	ilmThreeMetricTenDps.At(0).Attributes().Insert("label_name_23", pcommon.NewValueString("label_value_23"))
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(2345.67)
	ilmThreeMetricTenDps.At(1).Attributes().Insert("label_name_24", pcommon.NewValueString("label_value_24"))
	...
	ilmThreeMetricEleven.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricEleven.Sum().SetIsMonotonic(false)
	ilmThreeMetricEleven.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityDelta)
	ilmThreeMetricElevenDps := ilmThreeMetricEleven.Sum().DataPoints()
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(3456.78)
	ilmThreeMetricElevenDps.At(0).Attributes().Insert("label_name_25", pcommon.NewValueString("label_value_25"))
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(4567.89)
	ilmThreeMetricElevenDps.At(1).Attributes().Insert("label_name_26", pcommon.NewValueString("label_value_26"))
	...
	ilmThreeMetricTwelve.SetDataType(pmetric.MetricDataTypeSum)
	ilmThreeMetricTwelve.Sum().SetIsMonotonic(false)
	ilmThreeMetricTwelve.Sum().SetAggregationTemporality(pmetric.MetricAggregationTemporalityUnspecified)
	ilmThreeMetricTwelveDps := ilmThreeMetricTwelve.Sum().DataPoints()
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(5678.90)
	ilmThreeMetricTwelveDps.At(0).Attributes().Insert("label_name_27", pcommon.NewValueString("label_value_27"))
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(6789.01)
	ilmThreeMetricTwelveDps.At(1).Attributes().Insert("label_name_28", pcommon.NewValueString("label_value_28"))
	return metrics
}
