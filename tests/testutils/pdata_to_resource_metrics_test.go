...
func pdataMetrics() pdata.Metrics {
	...
	ilmOneMetricOneDps.At(0).Attributes().Insert("label_name_1", pdata.NewAttributeValueString("label_value_1"))
	ilmOneMetricOneDps.AppendEmpty().SetIntVal(23456)
	ilmOneMetricOneDps.At(1).Attributes().Insert("label_name_2", pdata.NewAttributeValueString("label_value_2"))
	...
	ilmOneMetricTwoDps.At(0).Attributes().Insert("label_name_3", pdata.NewAttributeValueString("label_value_3"))
	ilmOneMetricTwoDps.AppendEmpty().SetDoubleVal(345.67)
	ilmOneMetricTwoDps.At(1).Attributes().Insert("label_name_4", pdata.NewAttributeValueString("label_value_4"))
	...
	ilmThreeMetricOne.Sum().SetAggregationTemporality(pdata.AggregationTemporalityCumulative)
	ilmThreeMetricOneDps := ilmThreeMetricOne.Sum().DataPoints()
	ilmThreeMetricOneDps.AppendEmpty().SetIntVal(34567)
	ilmThreeMetricOneDps.At(0).Attributes().Insert("label_name_5", pdata.NewAttributeValueString("label_value_5"))
	ilmThreeMetricOneDps.AppendEmpty().SetIntVal(45678)
	ilmThreeMetricOneDps.At(1).Attributes().Insert("label_name_6", pdata.NewAttributeValueString("label_value_6"))
	...
	ilmThreeMetricTwo.Sum().SetAggregationTemporality(pdata.AggregationTemporalityDelta)
	ilmThreeMetricTwoDps := ilmThreeMetricTwo.Sum().DataPoints()
	ilmThreeMetricTwoDps.AppendEmpty().SetIntVal(56789)
	ilmThreeMetricTwoDps.At(0).Attributes().Insert("label_name_7", pdata.NewAttributeValueString("label_value_7"))
	ilmThreeMetricTwoDps.AppendEmpty().SetIntVal(67890)
	ilmThreeMetricTwoDps.At(1).Attributes().Insert("label_name_8", pdata.NewAttributeValueString("label_value_8"))
	...
	ilmThreeMetricThree.Sum().SetAggregationTemporality(pdata.AggregationTemporalityUnspecified)
	ilmThreeMetricThreeDps := ilmThreeMetricThree.Sum().DataPoints()
	ilmThreeMetricThreeDps.AppendEmpty().SetIntVal(78901)
	ilmThreeMetricThreeDps.At(0).Attributes().Insert("label_name_9", pdata.NewAttributeValueString("label_value_9"))
	ilmThreeMetricThreeDps.AppendEmpty().SetIntVal(89012)
	ilmThreeMetricThreeDps.At(1).Attributes().Insert("label_name_10", pdata.NewAttributeValueString("label_value_10"))
	...
	ilmThreeMetricFour.Sum().SetAggregationTemporality(pdata.AggregationTemporalityCumulative)
	ilmThreeMetricFourDps := ilmThreeMetricFour.Sum().DataPoints()
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(456.78)
	ilmThreeMetricFourDps.At(0).Attributes().Insert("label_name_11", pdata.NewAttributeValueString("label_value_11"))
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(567.89)
	ilmThreeMetricFourDps.At(1).Attributes().Insert("label_name_12", pdata.NewAttributeValueString("label_value_12"))
	...
	ilmThreeMetricFive.Sum().SetAggregationTemporality(pdata.AggregationTemporalityDelta)
	ilmThreeMetricFiveDps := ilmThreeMetricFive.Sum().DataPoints()
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(678.90)
	ilmThreeMetricFiveDps.At(0).Attributes().Insert("label_name_13", pdata.NewAttributeValueString("label_value_13"))
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(789.01)
	ilmThreeMetricFiveDps.At(1).Attributes().Insert("label_name_14", pdata.NewAttributeValueString("label_value_14"))
	...
	ilmThreeMetricSix.Sum().SetAggregationTemporality(pdata.AggregationTemporalityUnspecified)
	ilmThreeMetricSixDps := ilmThreeMetricSix.Sum().DataPoints()
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(890.12)
	ilmThreeMetricSixDps.At(0).Attributes().Insert("label_name_15", pdata.NewAttributeValueString("label_value_15"))
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(901.23)
	ilmThreeMetricSixDps.At(1).Attributes().Insert("label_name_16", pdata.NewAttributeValueString("label_value_16"))
	...
	ilmThreeMetricSeven.Sum().SetAggregationTemporality(pdata.AggregationTemporalityCumulative)
	ilmThreeMetricSevenDps := ilmThreeMetricSeven.Sum().DataPoints()
	ilmThreeMetricSevenDps.AppendEmpty().SetIntVal(90123)
	ilmThreeMetricSevenDps.At(0).Attributes().Insert("label_name_17", pdata.NewAttributeValueString("label_value_17"))
	ilmThreeMetricSevenDps.AppendEmpty().SetIntVal(123456)
	ilmThreeMetricSevenDps.At(1).Attributes().Insert("label_name_18", pdata.NewAttributeValueString("label_value_18"))
	...
	ilmThreeMetricEight.Sum().SetAggregationTemporality(pdata.AggregationTemporalityDelta)
	ilmThreeMetricEightDps := ilmThreeMetricEight.Sum().DataPoints()
	ilmThreeMetricEightDps.AppendEmpty().SetIntVal(234567)
	ilmThreeMetricEightDps.At(0).Attributes().Insert("label_name_19", pdata.NewAttributeValueString("label_value_19"))
	ilmThreeMetricEightDps.AppendEmpty().SetIntVal(345678)
	ilmThreeMetricEightDps.At(1).Attributes().Insert("label_name_20", pdata.NewAttributeValueString("label_value_20"))
	...
	ilmThreeMetricNine.Sum().SetAggregationTemporality(pdata.AggregationTemporalityUnspecified)
	ilmThreeMetricNineDps := ilmThreeMetricNine.Sum().DataPoints()
	ilmThreeMetricNineDps.AppendEmpty().SetIntVal(456789)
	ilmThreeMetricNineDps.At(0).Attributes().Insert("label_name_21", pdata.NewAttributeValueString("label_value_21"))
	ilmThreeMetricNineDps.AppendEmpty().SetIntVal(567890)
	ilmThreeMetricNineDps.At(1).Attributes().Insert("label_name_22", pdata.NewAttributeValueString("label_value_22"))
	...
	ilmThreeMetricTen.Sum().SetAggregationTemporality(pdata.AggregationTemporalityCumulative)
	ilmThreeMetricTenDps := ilmThreeMetricTen.Sum().DataPoints()
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(1234.56)
	ilmThreeMetricTenDps.At(0).Attributes().Insert("label_name_23", pdata.NewAttributeValueString("label_value_23"))
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(2345.67)
	ilmThreeMetricTenDps.At(1).Attributes().Insert("label_name_24", pdata.NewAttributeValueString("label_value_24"))
	...
	ilmThreeMetricEleven.Sum().SetAggregationTemporality(pdata.AggregationTemporalityDelta)
	ilmThreeMetricElevenDps := ilmThreeMetricEleven.Sum().DataPoints()
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(3456.78)
	ilmThreeMetricElevenDps.At(0).Attributes().Insert("label_name_25", pdata.NewAttributeValueString("label_value_25"))
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(4567.89)
	ilmThreeMetricElevenDps.At(1).Attributes().Insert("label_name_26", pdata.NewAttributeValueString("label_value_26"))
	...
	ilmThreeMetricTwelve.Sum().SetAggregationTemporality(pdata.AggregationTemporalityUnspecified)
	ilmThreeMetricTwelveDps := ilmThreeMetricTwelve.Sum().DataPoints()
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(5678.90)
	ilmThreeMetricTwelveDps.At(0).Attributes().Insert("label_name_27", pdata.NewAttributeValueString("label_value_27"))
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(6789.01)
	ilmThreeMetricTwelveDps.At(1).Attributes().Insert("label_name_28", pdata.NewAttributeValueString("label_value_28"))
	return metrics
}
