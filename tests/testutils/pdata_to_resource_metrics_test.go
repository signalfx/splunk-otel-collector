...
func pdataMetrics() pmetric.Metrics {
	...
	attrs.UpsertString("string", "a_string")
	attrs.UpsertInt("int", 123)
	attrs.UpsertDouble("double", 123.45)
	attrs.UpsertEmpty("null")
	...
	ilmOneMetricOneDps.At(0).Attributes().UpsertString("label_name_1", "label_value_1")
	ilmOneMetricOneDps.AppendEmpty().SetIntVal(23456)
	ilmOneMetricOneDps.At(1).Attributes().UpsertString("label_name_2", "label_value_2")
	...
	ilmOneMetricTwoDps.At(0).Attributes().UpsertString("label_name_3", "label_value_3")
	ilmOneMetricTwoDps.AppendEmpty().SetDoubleVal(345.67)
	ilmOneMetricTwoDps.At(1).Attributes().UpsertString("label_name_4", "label_value_4")
	...
	ilmThreeMetricOneDps.At(0).Attributes().UpsertString("label_name_5", "label_value_5")
	ilmThreeMetricOneDps.AppendEmpty().SetIntVal(45678)
	ilmThreeMetricOneDps.At(1).Attributes().UpsertString("label_name_6", "label_value_6")
	...
	ilmThreeMetricTwoDps.At(0).Attributes().UpsertString("label_name_7", "label_value_7")
	ilmThreeMetricTwoDps.AppendEmpty().SetIntVal(67890)
	ilmThreeMetricTwoDps.At(1).Attributes().UpsertString("label_name_8", "label_value_8")
	...
	ilmThreeMetricThreeDps.At(0).Attributes().UpsertString("label_name_9", "label_value_9")
	ilmThreeMetricThreeDps.AppendEmpty().SetIntVal(89012)
	ilmThreeMetricThreeDps.At(1).Attributes().UpsertString("label_name_10", "label_value_10")
	...
	ilmThreeMetricFourDps.At(0).Attributes().UpsertString("label_name_11", "label_value_11")
	ilmThreeMetricFourDps.AppendEmpty().SetDoubleVal(567.89)
	ilmThreeMetricFourDps.At(1).Attributes().UpsertString("label_name_12", "label_value_12")
	...
	ilmThreeMetricFiveDps.At(0).Attributes().UpsertString("label_name_13", "label_value_13")
	ilmThreeMetricFiveDps.AppendEmpty().SetDoubleVal(789.01)
	ilmThreeMetricFiveDps.At(1).Attributes().UpsertString("label_name_14", "label_value_14")
	...
	ilmThreeMetricSixDps.At(0).Attributes().UpsertString("label_name_15", "label_value_15")
	ilmThreeMetricSixDps.AppendEmpty().SetDoubleVal(901.23)
	ilmThreeMetricSixDps.At(1).Attributes().UpsertString("label_name_16", "label_value_16")
	...
	ilmThreeMetricSevenDps.At(0).Attributes().UpsertString("label_name_17", "label_value_17")
	ilmThreeMetricSevenDps.AppendEmpty().SetIntVal(123456)
	ilmThreeMetricSevenDps.At(1).Attributes().UpsertString("label_name_18", "label_value_18")
	...
	ilmThreeMetricEightDps.At(0).Attributes().UpsertString("label_name_19", "label_value_19")
	ilmThreeMetricEightDps.AppendEmpty().SetIntVal(345678)
	ilmThreeMetricEightDps.At(1).Attributes().UpsertString("label_name_20", "label_value_20")
	...
	ilmThreeMetricNineDps.At(0).Attributes().UpsertString("label_name_21", "label_value_21")
	ilmThreeMetricNineDps.AppendEmpty().SetIntVal(567890)
	ilmThreeMetricNineDps.At(1).Attributes().UpsertString("label_name_22", "label_value_22")
	...
	ilmThreeMetricTenDps.At(0).Attributes().UpsertString("label_name_23", "label_value_23")
	ilmThreeMetricTenDps.AppendEmpty().SetDoubleVal(2345.67)
	ilmThreeMetricTenDps.At(1).Attributes().UpsertString("label_name_24", "label_value_24")
	...
	ilmThreeMetricElevenDps.At(0).Attributes().UpsertString("label_name_25", "label_value_25")
	ilmThreeMetricElevenDps.AppendEmpty().SetDoubleVal(4567.89)
	ilmThreeMetricElevenDps.At(1).Attributes().UpsertString("label_name_26", "label_value_26")
	...
	ilmThreeMetricTwelveDps.At(0).Attributes().UpsertString("label_name_27", "label_value_27")
	ilmThreeMetricTwelveDps.AppendEmpty().SetDoubleVal(6789.01)
	ilmThreeMetricTwelveDps.At(1).Attributes().UpsertString("label_name_28", "label_value_28")
	return metrics
}
