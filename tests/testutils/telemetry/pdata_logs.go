...
func PDataLogs() plog.Logs {
	...
	slOneLogOne.Attributes().PutStr("attribute_name_1", "attribute_value_1")
	slOneLogOne.Attributes().PutStr("attribute_name_2", "attribute_value_2")
	...
	slOneLogTwo.Attributes().PutStr("attribute_name_3", "attribute_value_3")
	slOneLogTwo.Attributes().PutStr("attribute_name_4", "attribute_value_4")
	...
	slThreeLogOne.Attributes().PutStr("attribute_name_5", "attribute_value_5")
	slThreeLogOne.Attributes().PutStr("attribute_name_6", "attribute_value_6")
	...
	slThreeLogTwo.Attributes().PutStr("attribute_name_7", "attribute_value_7")
	slThreeLogTwo.Attributes().PutStr("attribute_name_8", "attribute_value_8")
	...
	slThreeLogThree.Attributes().PutStr("attribute_name_9", "attribute_value_9")
	slThreeLogThree.Attributes().PutStr("attribute_name_10", "attribute_value_10")
	...
	slThreeLogFour.Attributes().PutStr("attribute_name_11", "attribute_value_11")
	slThreeLogFour.Attributes().PutStr("attribute_name_12", "attribute_value_12")
